...
public class UpdateStudentAttribute {
	...
	public static void main(String[] args) throws IOException, JDOMException {
		...
		try {
			...
			boolean result = updateStudentAttributeInXML(rollNumber,attributeName, attributeValue, document);
			if (result) {
				...
				System.out.println("Student attribute has been updated successfully.");
			} else {
	...
	private static boolean updateStudentAttributeInXML(int rollNumber, String attributeName, String attributeValue, Document document) {
